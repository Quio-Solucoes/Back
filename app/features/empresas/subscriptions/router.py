...
def get_my_subscription(
    ...
    current_user: User = Depends(
        require_roles(MembershipRole.OWNER, MembershipRole.ADMIN, MembershipRole.COLABORADOR, MembershipRole.CONSULTOR)
    ),
...
def update_my_plan(
    ...
    db: Session = Depends(get_db),
    owner_user: User = Depends(require_roles(MembershipRole.OWNER)),
) -> SubscriptionResponse:
